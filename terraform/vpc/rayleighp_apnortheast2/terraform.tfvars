...
# Please change "rayleigh" to what you want to use
# p after name indicates production. This means that rayleighp_apnortheast2 VPC is for production environment VPC in Seoul Region.
vpc_name = "rayleighp_apnortheast2"
...
shard_id = "rayleighpapne2"
shard_short_id = "rayleigh01p"

# p means production
env_suffix = "p"

# VPC Peering Connection Variables
# vpc_peer_connection_id_rayleighd_apne2 = "pcx-"
# rayleighd_destination_cidr_block = "10.10.0.0/16"
...
#      peer_vpc_name                    = "rayleighd_apnortheast2"
